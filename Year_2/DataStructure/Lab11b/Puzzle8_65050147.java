...
public class Puzzle8_65050147 {
    int size = 3;
    int[] sequence; // 3 * 9
    ArrayList<Puzzle8State> explored;
    Stack<Puzzle8State> dfs;

    public Puzzle8_65050147(int[] seq)
    {
        sequence = seq;
        dfs = new Stack<>();
    ...
    public void nextMoveWithStack() {
        generateNextMoves();
        // generateNextMoves();
        // generateNextMoves(); generateNextMoves(); generateNextMoves();
        // generateNextMoves();
        // generateNextMoves(); generateNextMoves(); generateNextMoves();
        // generateNextMoves();
    }
    ...
    public void generateNextMoves() {
        // int blackPos =
        // Stream.of(sequence).filter(num -> num ==
        // 9).collect(Collectors.toList()).get(0);
        // int blackPos = Arrays.stream(sequence).filter(num -> num ==
        // 9).findFirst().getAsInt();
